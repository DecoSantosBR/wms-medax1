...
import { LayoutDashboard, LogOut, PanelLeft, Users, Package, Warehouse, TruckIcon, ClipboardList, Shield, Building2, BarChart3 } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Building2, label: "Pontos de Entrega", path: "/intra-hospitalar/pontos" },
  { icon: BarChart3, label: "SLA Intra-Hosp.", path: "/intra-hospitalar/sla" },
];
